...
SECRET_KEY = 'yetn9&xxfj)w+$uu(fcbl3(3+_$+8zq()ht#e0s^y3bsjoim$k'
...
#STATIC_ROOT = os.getenv(os.path.join(BASE_DIR, 'static'))

MEDIA_URL = os.getenv('DJANGO_MEDIA_URL', os.path.join(BASE_DIR, 'media/'))
